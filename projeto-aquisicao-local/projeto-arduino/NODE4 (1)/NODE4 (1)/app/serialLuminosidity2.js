...
const serial = new NewArduinoLuminosity2();
serial.SetConnection();

module.exports.ArduinoDataLuminosity2 = {List: serial.List, ListHour:serial.ListHour} 