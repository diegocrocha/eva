...
const serial = new NewArduinoLuminosity1();
serial.SetConnection();

module.exports.ArduinoDataLuminosity1 = {List: serial.List, ListHour:serial.ListHour} 